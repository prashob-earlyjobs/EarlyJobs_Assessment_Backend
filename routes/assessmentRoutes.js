  ...
  async (req, res) => {
    ...
    try {
      ...
      res.json({
        ...
        data: {
          ...response.data[0],
          publicLink: `https://platform.earlyjobs.ai/auth/?session_key=${response.access_token}&interview_id=${response.data[0].interviewId}&full_name=${req.body.firstName}&first_name=${req.body.firstName}&last_name=${req.body.lastName}&avatar_url=${req.body.avatar_url}&email_address=${req.body.email}`,
        },
      });
    } catch (error) {
