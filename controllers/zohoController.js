...
const ZOHO_BOOKS_API_BASE_URL = process.env.ZOHO_BOOKS_API_BASE_URL || "https://www.zohoapis.com/books/v3";
...
const createInvoice = async (req, res) => {
  try {
    ...
    if (invoice_number || referenceNumber) invoiceData.invoice_number = invoice_number || referenceNumber;
